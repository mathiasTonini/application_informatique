...
class Canon:
    ...
    def analyse_file_contain_rate_aux(self):
        ...
        folder_result_acquisition_babymind = "/home/mathias/Documents/unige/UNIGE/2eme/appliInfo/script/folder_result_acquisition_babymind"  #folder where i store my files that interface produce
    ...
    def _draw_trigger_rate_and_cosmic_flux(self):
        ...
        if answer:
            ...
            if self.flag_draw_trigger_rate == False:
                folder_result_acquisition_babymind = "/home/mathias/Documents/unige/UNIGE/2eme/appliInfo/script/folder_result_acquisition_babymind"
                for file_object in os.listdir(folder_result_acquisition_babymind):
    ...
    def plot_pixels_grid_bis(self,pixels, data_from_electronics):
        ...
        self.fig_fen1.savefig("/home/sterody/Documents/mini_cam_event_display/resultat_acquisition_babymind/figures/fig_%s"%self.number_figure)
